...
updated: 2023-12-07 12:48:32 +0900
tags:
  - 컴퓨터-네트워킹-하향식-접근
---
...
클라이언트-서버의 경우 피어의 수가 증가함에 따라 최소 분배 시간이 선형적으로, 한계없이 증가하지만 P2P 구조의 경우 최소 분배 시간이 클라이언트-서버 구조의 분배 시간보다 항상 작지는 않다. 또한 *임의의* 피어 수 N에 대해 3