...
updated: 2023-09-22 15:42:56 +0900
tags:
  - java
  - os
  - cs
...
각 코드를 개별적으로 수행하면 올바르게 동작하지 않을 것이다.  count 가 4일 때 생산자와 소비자가 동시에 count++, count-- 를 수행하면 count 는 4, 5, 6 의 값을 가질 수 있다. 동시성이 보장되지 않는 것이다.  
